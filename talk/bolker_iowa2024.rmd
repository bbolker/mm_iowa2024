...
A partial solution to the Babel of the R ecosystem: multi-use front- and back-ends for workflow construction
...
* METIS/SuiteSparse/CHOLMOD (Davis, Karypis: used in `lme4`, `TMB`)
* INLA meshes (Lindgren, Rue)
...
* CppAD, TMB (Kristensen), Stan (Carpenter/Betancourt), PyTorch, Tensorflow (`greta`), NIMBLE (de Valpine)
* memory-intensive
...
* INLA meshes leverage *conditional independence* of spatial points to handle spatial problems efficiently
...
include_graphics("pix/bubbles.jpg")
```
