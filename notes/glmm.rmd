...
-   accounting for correlations among observations within *clusters* ("levels of the grouping variable")
...
- the hard part is that we need to compute an integral
- deterministic
...
- for CIs, *profile confidence intervals* (slow)
...
- Choosing the complexity of RE components (**singular fits**): [@barr_random_2013, @bates_parsimonious_2015]
- Big data: speed!
- Model diagnosis
